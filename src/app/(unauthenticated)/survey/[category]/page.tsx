  ...
  return (
    <div className='h-fit flex justify-center py-16'>
      <div className='h-full max-w-3xl text-prose'>
        <h1 className='text-3xl sm:text-5xl leading-loose font-normal tracking-tighter text-center leading-tight mb-10 mx-5'>Compare quotes from top-rated <span className='text-primary'>{ category !== 'base' ? category : '' }</span> contractors</h1>
