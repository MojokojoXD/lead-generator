export default function AboutPage()
{
  return (
    <section className='px-[5%] lg:px-[6.5%] py-10 h-fit text-prose'>
      <div className='h-full max-w-2xl xl:max-w-3xl text-xl text-prose mx-auto'>
        <p className='mb-4'>
        ...
        <h3 className='text-lg font-medium text-primary'>🛒 Get Discounts</h3>
        <p className='mb-4'>
          Access exclusive deals on home products, furniture, and décor from local retailers in your area.
        </p>
        <h3 className='text-lg font-medium text-primary'>🛠️ Get Quotes</h3>
        <p className='mb-4'>
        ...
        <h3 className='text-lg font-medium text-primary'>🔧 Setup & Installation Help</h3>
        <p className='mb-4'>
