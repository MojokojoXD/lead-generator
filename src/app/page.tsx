...
export default function Home()
{
  return (
    <div className="h-fit w-full px-[5%] lg:px-[10%] home-categories bg-cover">
      <section className='h-full w-full pt-20 sm:pt-24 sm:grid grid-cols-2 gap-5'>
        <div className='pb-24'>
          <h1 className='text-7xl sm:text-8xl font-bold tracking-tighter text-zinc-800 mb-3.5'>Find highly <br />rated <br />certified pros <br /> in <span className='text-primary'>Arizona</span></h1>
          <p className='text-xl sm:text-2xl mb-5 max-w-prose'>Lorem ipsum dolor sit amet consectetur adipiscing elit. Dolor sit amet consectetur adipiscing elit quisque faucibus.</p>
          <Button variant={ 'secondary' } className='h-[3.25rem] sm:h-[4.25rem] w-[11.4rem] sm:w-[19.8rem] text-xl sm:text-2xl'>Get a Quote!</Button>
        </div>
        <div className='pb-24 grid grid-cols-2 auto-cols-fr gap-4'>
          <Link href={ '#' }>
