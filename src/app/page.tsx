        ...
        <div className='pb-24 space-y-8'>
          <div className='leading-loose text-xl'>
            ...
            <Link href={ '/marketplace' } className='block'>
              <h2 className='text-primary'>Save on Home Items</h2>
              <p className='leading-normal max-w-md'>Get Deals on furniture, décor and essentials nearby.</p>
            </Link>
            <Link href={ '/survey-projects/base' } className='block'>
              <h2 className='text-primary'>Get project quotes</h2>
            ...
            <Link href={ '/handyman' } className='block'>
              <h2 className='text-primary'>Hire Handyman</h2>
